%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MATLAB Code: Aiyagari_GE.m
% 
% Author: Muhammad (Modified section code from Kiyea)
% dkte: Nov 7, 2024
%
% Description:
% This MATLAB script solves the general equilibrium of the Aiyagari model with idiosyncratic shocks. We will find equilibirum interest rate that will clear the market.
%
% Reference: Huggett_equilibrium_iterate.m by Benjkmin Moll 
%
% Notes:
...
for n=1:p.maxit
    ...
    % V = B\b;
    V_updkte = B\b; % 2I*1 matrix
    V_change = V_updkte - V_stacked;
    V = reshape(V_updkte, p.I, 2); % I*2 matrix
